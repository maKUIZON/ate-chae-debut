          ...
          <div   className="relative group w-fit"       
            >
              <Image 
                ...
                height={100}
              />
              <div className="absolute top-10 left-1/2 -translate-x-1/2 -translate-y-1/2 text-black text-3xl">
               {String(timeLeft.hours).padStart(2, "0")} :{String(timeLeft.hours).padStart(2, "0")} :{String(timeLeft.minutes).padStart(2, "0")} :{String(timeLeft.seconds).padStart(2, "0")}
              </div>
          </div>
